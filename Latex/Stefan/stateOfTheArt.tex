...
This section examines the internal decision logic of prominent isolation-based algorithms. While these methods share the goal of isolating anomalies through recursive partitioning, they differ fundamentally in their \textbf{splitting strategies}—specifically in how they select the splitting dimensions, normal vectors, and cut points. The integration of this part of the algorithm is shared with the model from \cite{cortes2019imputing}, FCF, and is described in Section \ref{forestConstruction} and Section \ref{scoring}, along with the node splitting strategy of FCF.
