...
1. Original Isolation Forest: Liu et al. (2008, 2012)
2. Extended Isolation Forest: Hariri et al. (2019)
3. SCiForest: Liu et al. (2019)
4. Fair-Cut Forest: Cortes (2021) - **This paper**
5. RRCF: Guha et al. (2016)
6. DET: Ram & Gray (2011)

## 👨‍💻 Author

Experiments replicated by David
Date: January 2026
Based on: https://arxiv.org/pdf/2110.13402
